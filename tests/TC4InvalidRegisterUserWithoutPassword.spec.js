...
test.describe("Register User", () => {
    ...
    //6. Enter email and username and click 'register' button
    ///8. Verify that user is not created

    test("TC4InvalidRegisterUserWithoutPassword.spec.js", async ({ page }) => {
        ...
        await registerPage1.fillForm(registerPage1.username,"testko12345")
